...
public class PathmindUser extends TableImpl<PathmindUserRecord> {
    ...
    private static final long serialVersionUID = 1197781500;
     ...
     */
    public final TableField<PathmindUserRecord, Integer> ACCOUNT_TYPE = createField("account_type", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>public.pathmind_user.firstname</code>.
     */
    public final TableField<PathmindUserRecord, String> FIRSTNAME = createField("firstname", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.pathmind_user.lastname</code>.
     */
    public final TableField<PathmindUserRecord, String> LASTNAME = createField("lastname", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.pathmind_user.address</code>.
     */
    public final TableField<PathmindUserRecord, String> ADDRESS = createField("address", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.pathmind_user.city</code>.
     */
    public final TableField<PathmindUserRecord, String> CITY = createField("city", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.pathmind_user.state</code>.
     */
    public final TableField<PathmindUserRecord, String> STATE = createField("state", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.pathmind_user.country</code>.
     */
    public final TableField<PathmindUserRecord, String> COUNTRY = createField("country", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.pathmind_user.zip</code>.
     */
    public final TableField<PathmindUserRecord, String> ZIP = createField("zip", org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");
