...
public class ExecutionProviderMetaData extends TableImpl<ExecutionProviderMetaDataRecord> {
    ...
    private static final long serialVersionUID = 2125507978;
     ...
     */
    public final TableField<ExecutionProviderMetaDataRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.execution_provider_meta_data.provider_class</code>.
     */
    public final TableField<ExecutionProviderMetaDataRecord, String> PROVIDER_CLASS = createField("provider_class", org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>public.execution_provider_meta_data.key</code>.
     */
    public final TableField<ExecutionProviderMetaDataRecord, String> KEY = createField("key", org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * @deprecated Unknown data type. Please define an explicit {@link org.jooq.Binding} to specify how this type should be handled. Deprecation can be turned off using {@literal <deprecationOnUnknownTypes/>} in your code generator configuration.
     */
    @java.lang.Deprecated
    public final TableField<ExecutionProviderMetaDataRecord, Object> VALUE = createField("value", org.jooq.impl.SQLDataType.OTHER, this, "");
