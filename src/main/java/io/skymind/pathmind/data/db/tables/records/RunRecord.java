...
public class RunRecord extends UpdatableRecordImpl<RunRecord> implements Record6<Long, Long, String, Integer, LocalDateTime, LocalDateTime> {

    private static final long serialVersionUID = 1425232909;
     ...
     */
    @Override
    public RunRecord values(Long value1, Long value2, String value3, Integer value4, LocalDateTime value5, LocalDateTime value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RunRecord(Long id, Long experimentId, String name, Integer runType, LocalDateTime startDatetime, LocalDateTime endDatetime) {
        super(Run.RUN);
