...
public class RunRecord extends UpdatableRecordImpl<RunRecord> implements Record6<Long, Long, String, Integer, LocalDateTime, String> {

    private static final long serialVersionUID = 1003298302;
     ...
     */
    @Override
    public Row6<Long, Long, String, Integer, LocalDateTime, String> fieldsRow() {
     ...
     */
    @Override
    public Row6<Long, Long, String, Integer, LocalDateTime, String> valuesRow() {
     ...
     */
    @Override
    public RunRecord values(Long value1, Long value2, String value3, Integer value4, LocalDateTime value5, String value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RunRecord(Long id, Long experimentId, String name, Integer runType, LocalDateTime startDatetime, String score) {
        super(Run.RUN);
