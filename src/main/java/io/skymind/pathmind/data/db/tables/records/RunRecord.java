...
public class RunRecord extends UpdatableRecordImpl<RunRecord> implements Record9<Long, Long, String, Integer, LocalDateTime, LocalDateTime, Integer, LocalDateTime, Long> {

    private static final long serialVersionUID = 2065404903;
    ...
    @Override
    public Row9<Long, Long, String, Integer, LocalDateTime, LocalDateTime, Integer, LocalDateTime, Long> valuesRow() {
    ...
    @Override
    public RunRecord values(Long value1, Long value2, String value3, Integer value4, LocalDateTime value5, LocalDateTime value6, Integer value7, LocalDateTime value8, Long value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RunRecord(Long id, Long experimentId, String name, Integer runType, LocalDateTime startedAt, LocalDateTime stoppedAt, Integer status, LocalDateTime notificationSentAt, Long trainingErrorId) {
        super(Run.RUN);
