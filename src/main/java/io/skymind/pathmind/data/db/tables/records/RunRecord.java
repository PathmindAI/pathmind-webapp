...
public class RunRecord extends UpdatableRecordImpl<RunRecord> implements Record7<Long, Long, String, Integer, LocalDateTime, LocalDateTime, Integer> {
    ...
    private static final long serialVersionUID = -2071264230;
    ...
    @Override
    public Row7<Long, Long, String, Integer, LocalDateTime, LocalDateTime, Integer> fieldsRow() {
        return (Row7) super.fieldsRow();
    }

    @Override
    public Row7<Long, Long, String, Integer, LocalDateTime, LocalDateTime, Integer> valuesRow() {
    ...
    @Override
    public RunRecord values(Long value1, Long value2, String value3, Integer value4, LocalDateTime value5, LocalDateTime value6, Integer value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
