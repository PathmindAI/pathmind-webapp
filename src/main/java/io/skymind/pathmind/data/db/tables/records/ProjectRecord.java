...
public class ProjectRecord extends UpdatableRecordImpl<ProjectRecord> implements Record5<Long, Long, String, LocalDate, LocalDate> {

    private static final long serialVersionUID = -43061275;
     ...
     */
    @Override
    public ProjectRecord values(Long value1, Long value2, String value3, LocalDate value4, LocalDate value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ProjectRecord(Long id, Long pathmindUserId, String name, LocalDate dateCreated, LocalDate lastActivityDate) {
        super(Project.PROJECT);
