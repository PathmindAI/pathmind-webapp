...
public class ProjectRecord extends UpdatableRecordImpl<ProjectRecord> implements Record5<Long, Long, String, LocalDate, LocalDateTime> {

    private static final long serialVersionUID = -2010173942;
     ...
     */
    @Override
    public Row5<Long, Long, String, LocalDate, LocalDateTime> fieldsRow() {
     ...
     */
    @Override
    public Row5<Long, Long, String, LocalDate, LocalDateTime> valuesRow() {
     ...
     */
    @Override
    public ProjectRecord values(Long value1, Long value2, String value3, LocalDate value4, LocalDateTime value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ProjectRecord(Long id, Long pathmindUserId, String name, LocalDate lastActivityDate, LocalDateTime dateCreated) {
        super(Project.PROJECT);
