...
public class ProjectRecord extends UpdatableRecordImpl<ProjectRecord> implements Record6<Long, Long, String, LocalDateTime, LocalDateTime, Boolean> {

    private static final long serialVersionUID = 1491807167;
    ...
    @Override
    public Row6<Long, Long, String, LocalDateTime, LocalDateTime, Boolean> valuesRow() {
    ...
    @Override
    public ProjectRecord values(Long value1, Long value2, String value3, LocalDateTime value4, LocalDateTime value5, Boolean value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ProjectRecord(Long id, Long pathmindUserId, String name, LocalDateTime dateCreated, LocalDateTime lastActivityDate, Boolean archived) {
        super(Project.PROJECT);
