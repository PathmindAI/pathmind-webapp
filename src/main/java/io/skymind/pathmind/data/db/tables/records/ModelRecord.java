...
public class ModelRecord extends UpdatableRecordImpl<ModelRecord> implements Record11<Long, Long, String, LocalDateTime, LocalDateTime, Integer, Integer, String, Boolean, String, Integer> {

    private static final long serialVersionUID = 2024582216;
    ...
    @Override
    public Row11<Long, Long, String, LocalDateTime, LocalDateTime, Integer, Integer, String, Boolean, String, Integer> valuesRow() {
    ...
    @Override
    public ModelRecord values(Long value1, Long value2, String value3, LocalDateTime value4, LocalDateTime value5, Integer value6, Integer value7, String value8, Boolean value9, String value10, Integer value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ModelRecord(Long id, Long projectId, String name, LocalDateTime dateCreated, LocalDateTime lastActivityDate, Integer numberOfObservations, Integer numberOfPossibleActions, String getObservationForRewardFunction, Boolean archived, String userNotes, Integer rewardVariablesCount) {
        super(Model.MODEL);
