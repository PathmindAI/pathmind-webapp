...
public class ModelRecord extends UpdatableRecordImpl<ModelRecord> implements Record10<Long, Long, String, LocalDateTime, LocalDateTime, Integer, Integer, String, byte[], Boolean> {

    private static final long serialVersionUID = -1190204280;
    ...
    @Override
    public Row10<Long, Long, String, LocalDateTime, LocalDateTime, Integer, Integer, String, byte[], Boolean> valuesRow() {
    ...
    @Override
    public ModelRecord values(Long value1, Long value2, String value3, LocalDateTime value4, LocalDateTime value5, Integer value6, Integer value7, String value8, byte[] value9, Boolean value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ModelRecord(Long id, Long projectId, String name, LocalDateTime dateCreated, LocalDateTime lastActivityDate, Integer numberOfObservations, Integer numberOfPossibleActions, String getObservationForRewardFunction, byte[] file, Boolean archived) {
        super(Model.MODEL);
