...
public class ModelRecord extends UpdatableRecordImpl<ModelRecord> implements Record11<Long, Long, String, LocalDateTime, LocalDateTime, Integer, Integer, String, Boolean, String, Boolean> {

    private static final long serialVersionUID = 986830822;
    ...
    /**
     * Setter for <code>public.model.model_file_moved_to_s3</code>.
     */
    public void setModelFileMovedToS3(Boolean value) {
        set(10, value);
    }

    /**
     * Getter for <code>public.model.model_file_moved_to_s3</code>.
     */
    public Boolean getModelFileMovedToS3() {
    ...
    @Override
    public Row11<Long, Long, String, LocalDateTime, LocalDateTime, Integer, Integer, String, Boolean, String, Boolean> valuesRow() {
    ...
    public Field<Boolean> field11() {
        return Model.MODEL.MODEL_FILE_MOVED_TO_S3;
    }
    ...
    public ModelRecord value11(Boolean value) {
        setModelFileMovedToS3(value);
        return this;
    }

    @Override
    public ModelRecord values(Long value1, Long value2, String value3, LocalDateTime value4, LocalDateTime value5, Integer value6, Integer value7, String value8, Boolean value9, String value10, Boolean value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ModelRecord(Long id, Long projectId, String name, LocalDateTime dateCreated, LocalDateTime lastActivityDate, Integer numberOfObservations, Integer numberOfPossibleActions, String getObservationForRewardFunction, Boolean archived, String userNotes, Boolean modelFileMovedToS3) {
        super(Model.MODEL);
