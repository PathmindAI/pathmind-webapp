...
public class PolicyRecord extends UpdatableRecordImpl<PolicyRecord> implements Record13<Long, Long, String, String, JSONB, byte[], LocalDateTime, LocalDateTime, String, byte[], Double, Double, Integer> {

    private static final long serialVersionUID = 1994665791;
    ...
    @Override
    public Row13<Long, Long, String, String, JSONB, byte[], LocalDateTime, LocalDateTime, String, byte[], Double, Double, Integer> fieldsRow() {
        return (Row13) super.fieldsRow();
    }

    @Override
    public Row13<Long, Long, String, String, JSONB, byte[], LocalDateTime, LocalDateTime, String, byte[], Double, Double, Integer> valuesRow() {
    ...
    @Override
    public PolicyRecord values(Long value1, Long value2, String value3, String value4, JSONB value5, byte[] value6, LocalDateTime value7, LocalDateTime value8, String value9, byte[] value10, Double value11, Double value12, Integer value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PolicyRecord(Long id, Long runId, String externalId, String name, JSONB progress, byte[] file, LocalDateTime startedat, LocalDateTime stoppedat, String algorithm, byte[] snapshot, Double learningRate, Double gamma, Integer batchSize) {
        super(Policy.POLICY);
