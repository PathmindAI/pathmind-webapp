...
public class PolicyRecord extends UpdatableRecordImpl<PolicyRecord> implements Record13<Long, Long, String, String, LocalDateTime, LocalDateTime, String, Double, Double, Integer, String, LocalDateTime, Boolean> {

    private static final long serialVersionUID = 935722451;
    ...
    @Override
    public Row13<Long, Long, String, String, LocalDateTime, LocalDateTime, String, Double, Double, Integer, String, LocalDateTime, Boolean> valuesRow() {
    ...
    @Override
    public PolicyRecord values(Long value1, Long value2, String value3, String value4, LocalDateTime value5, LocalDateTime value6, String value7, Double value8, Double value9, Integer value10, String value11, LocalDateTime value12, Boolean value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PolicyRecord(Long id, Long runId, String externalId, String name, LocalDateTime startedAt, LocalDateTime stoppedAt, String algorithm, Double learningRate, Double gamma, Integer batchSize, String notes, LocalDateTime exportedAt, Boolean hasFile) {
        super(Policy.POLICY);
