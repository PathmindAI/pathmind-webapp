...
public class PolicyRecord extends UpdatableRecordImpl<PolicyRecord> implements Record9<Long, Long, String, String, JSONB, byte[], LocalDateTime, LocalDateTime, String> {

    private static final long serialVersionUID = -1820954;
    ...
    @Override
    public Row9<Long, Long, String, String, JSONB, byte[], LocalDateTime, LocalDateTime, String> valuesRow() {
    ...
    @Override
    public PolicyRecord values(Long value1, Long value2, String value3, String value4, JSONB value5, byte[] value6, LocalDateTime value7, LocalDateTime value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PolicyRecord(Long id, Long runId, String externalId, String name, JSONB progress, byte[] file, LocalDateTime startedat, LocalDateTime stoppedat, String algorithm) {
        super(Policy.POLICY);
