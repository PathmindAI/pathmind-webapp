...
public class PolicyRecord extends UpdatableRecordImpl<PolicyRecord> implements Record15<Long, Long, String, String, LocalDateTime, LocalDateTime, String, Double, Double, Integer, String, LocalDateTime, Boolean, Boolean, Boolean> {

    private static final long serialVersionUID = 1121821355;
    ...
    /**
     * Setter for <code>public.policy.policy_file_moved_to_s3</code>.
     */
    public void setPolicyFileMovedToS3(Boolean value) {
        set(12, value);
    }

    /**
     * Getter for <code>public.policy.policy_file_moved_to_s3</code>.
     */
    public Boolean getPolicyFileMovedToS3() {
        return (Boolean) get(12);
    }

    /**
     * Setter for <code>public.policy.policy_snapshot_moved_to_s3</code>.
     */
    public void setPolicySnapshotMovedToS3(Boolean value) {
        set(13, value);
    }

    /**
     * Getter for <code>public.policy.policy_snapshot_moved_to_s3</code>.
     */
    public Boolean getPolicySnapshotMovedToS3() {
    ...
    @Override
    public Row15<Long, Long, String, String, LocalDateTime, LocalDateTime, String, Double, Double, Integer, String, LocalDateTime, Boolean, Boolean, Boolean> fieldsRow() {
        return (Row15) super.fieldsRow();
    }

    @Override
    public Row15<Long, Long, String, String, LocalDateTime, LocalDateTime, String, Double, Double, Integer, String, LocalDateTime, Boolean, Boolean, Boolean> valuesRow() {
    ...
    public Field<Boolean> field13() {
        return Policy.POLICY.POLICY_FILE_MOVED_TO_S3;
    }

    @Override
    public Field<Boolean> field14() {
        return Policy.POLICY.POLICY_SNAPSHOT_MOVED_TO_S3;
    }
    ...
    public Boolean component13() {
        return getPolicyFileMovedToS3();
    }

    @Override
    public Boolean component14() {
        return getPolicySnapshotMovedToS3();
    }
    ...
    @Override
    public PolicyRecord value13(Boolean value) {
        setPolicyFileMovedToS3(value);
        return this;
    }

    @Override
    public PolicyRecord value14(Boolean value) {
        setPolicySnapshotMovedToS3(value);
        return this;
    }

    @Override
    public PolicyRecord value15(Boolean value) {
        setHasFile(value);
        return this;
    }

    @Override
    public PolicyRecord values(Long value1, Long value2, String value3, String value4, LocalDateTime value5, LocalDateTime value6, String value7, Double value8, Double value9, Integer value10, String value11, LocalDateTime value12, Boolean value13, Boolean value14, Boolean value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PolicyRecord(Long id, Long runId, String externalId, String name, LocalDateTime startedAt, LocalDateTime stoppedAt, String algorithm, Double learningRate, Double gamma, Integer batchSize, String notes, LocalDateTime exportedAt, Boolean policyFileMovedToS3, Boolean policySnapshotMovedToS3, Boolean hasFile) {
        super(Policy.POLICY);
        ...
        set(10, notes);
        set(11, exportedAt);
        set(12, policyFileMovedToS3);
        set(13, policySnapshotMovedToS3);
        set(14, hasFile);
    }
}
