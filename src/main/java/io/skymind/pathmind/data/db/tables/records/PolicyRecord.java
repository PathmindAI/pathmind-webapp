...
public class PolicyRecord extends UpdatableRecordImpl<PolicyRecord> implements Record6<Long, Long, String, String, Object, byte[]> {

    private static final long serialVersionUID = 1993390896;
     ...
     */
    @Override
    public Row6<Long, Long, String, String, Object, byte[]> fieldsRow() {
     ...
     */
    @Override
    public Row6<Long, Long, String, String, Object, byte[]> valuesRow() {
     ...
     */
    @Override
    public PolicyRecord values(Long value1, Long value2, String value3, String value4, Object value5, byte[] value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PolicyRecord(Long id, Long runId, String name, String externalId, Object progress, byte[] file) {
        super(Policy.POLICY);
