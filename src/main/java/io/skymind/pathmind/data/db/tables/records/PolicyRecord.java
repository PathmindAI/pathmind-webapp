...
public class PolicyRecord extends UpdatableRecordImpl<PolicyRecord> implements Record7<Long, Long, String, Integer, Object, byte[], byte[]> {

    private static final long serialVersionUID = -603564605;
     ...
     */
    @Override
    public Row7<Long, Long, String, Integer, Object, byte[], byte[]> fieldsRow() {
     ...
     */
    @Override
    public Row7<Long, Long, String, Integer, Object, byte[], byte[]> valuesRow() {
     ...
     */
    @Override
    public PolicyRecord values(Long value1, Long value2, String value3, Integer value4, Object value5, byte[] value6, byte[] value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PolicyRecord(Long id, Long runId, String name, Integer algorithm, Object score, byte[] hyperParameters, byte[] file) {
        super(Policy.POLICY);
