...
public class PolicyRecord extends UpdatableRecordImpl<PolicyRecord> implements Record9<Long, Long, String, Integer, Object, byte[], byte[], String, Object> {

    private static final long serialVersionUID = -708144346;
     ...
     */
    @Override
    public Row9<Long, Long, String, Integer, Object, byte[], byte[], String, Object> fieldsRow() {
     ...
     */
    @Override
    public Row9<Long, Long, String, Integer, Object, byte[], byte[], String, Object> valuesRow() {
     ...
     */
    @Override
    public PolicyRecord value7(byte... value) {
        setFile(value);
        return this;
    }
    ...
    @java.lang.Deprecated
    @Override
    public PolicyRecord value9(Object value) {
        setProgress(value);
        return this;
    }
     ...
     */
    @Override
    public PolicyRecord values(Long value1, Long value2, String value3, Integer value4, Object value5, byte[] value6, byte[] value7, String value8, Object value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PolicyRecord(Long id, Long runId, String name, Integer algorithm, Object score, byte[] hyperParameters, byte[] file, String externalId, Object progress) {
        super(Policy.POLICY);
