...
public class SubscriptionCancelDialog extends ConfirmDialog {
	...
	public SubscriptionCancelDialog(UI ui, Long periodEndEpoch, Command cancelEvent) {
        this.setHeader("Cancel Your Subscription?");
        this.setConfirmButton("Cancel Subscription", confirmEvent -> cancelEvent.execute(), "error primary");
