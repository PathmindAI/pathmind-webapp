...
public class SharedExperimentView extends ExperimentView {
    ...
    protected ExperimentTitleBar createExperimentTitleBar() {
        return new ExperimentTitleBar(this, this::updateComponents, this::getExperimentLock, getUISupplier(), runDAO, featureManager, policyDAO, policyFileService, policyServerService, trainingService, modelService, true);
    }
