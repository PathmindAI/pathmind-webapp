...
public class ServePolicyAction {
    ...
    public static void servePolicy(Supplier<Experiment> getExperimentSupplier) {
        createInstructionDialog(getExperimentSupplier);
    }

    private static void createInstructionDialog(Supplier<Experiment> getExperimentSupplier) {
