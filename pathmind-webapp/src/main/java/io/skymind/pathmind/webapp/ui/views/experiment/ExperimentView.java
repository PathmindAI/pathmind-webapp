...
public class ExperimentView extends AbstractExperimentView {
    ...
    protected ExperimentTitleBar createExperimentTitleBar() {
        return new ExperimentTitleBar(this, this::updateComponents, this::getExperimentLock, getUISupplier(), runDAO, featureManager, trainingService, modelService);
    }

    private ExperimentTitleBar createComparisonExperimentTitleBar() {
        return new ExperimentTitleBar(this, this::updateComparisonComponents, this::getComparisonExperimentLock, getUISupplier(), runDAO, featureManager, trainingService, modelService);
    }
