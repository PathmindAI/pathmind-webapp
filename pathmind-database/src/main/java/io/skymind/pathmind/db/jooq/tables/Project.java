...
public class Project extends TableImpl<ProjectRecord> {
     ...
     */
    public final TableField<ProjectRecord, Long> PATHMIND_USER_ID = createField(DSL.name("pathmind_user_id"), SQLDataType.BIGINT.nullable(false), this, "");
     ...
     */
    public final TableField<ProjectRecord, LocalDateTime> DATE_CREATED = createField(DSL.name("date_created"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("now()", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>public.project.last_activity_date</code>.
     */
    public final TableField<ProjectRecord, LocalDateTime> LAST_ACTIVITY_DATE = createField(DSL.name("last_activity_date"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("now()", SQLDataType.LOCALDATETIME)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.PROJECT_PATHMIND_USER_FK_INDEX);
    }
    ...
    private transient PathmindUser _pathmindUser;

    public PathmindUser pathmindUser() {
        if (_pathmindUser == null) {
            _pathmindUser = new PathmindUser(this, Keys.PROJECT__PM_FK_PROJECT_PATHMIND_USER);
        }

        return _pathmindUser;
    }
