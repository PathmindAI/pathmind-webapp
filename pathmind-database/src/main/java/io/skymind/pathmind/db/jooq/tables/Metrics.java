...
public class Metrics extends TableImpl<MetricsRecord> {
     ...
     */
    public final TableField<MetricsRecord, Long> POLICY_ID = createField(DSL.name("policy_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.metrics.index</code>.
     */
    public final TableField<MetricsRecord, Integer> INDEX = createField(DSL.name("index"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.metrics.min</code>.
     */
    public final TableField<MetricsRecord, BigDecimal> MIN = createField(DSL.name("min"), SQLDataType.NUMERIC(32, 17), this, "");

    /**
     * The column <code>public.metrics.mean</code>.
     */
    public final TableField<MetricsRecord, BigDecimal> MEAN = createField(DSL.name("mean"), SQLDataType.NUMERIC(32, 17), this, "");

    /**
     * The column <code>public.metrics.max</code>.
     */
    public final TableField<MetricsRecord, BigDecimal> MAX = createField(DSL.name("max"), SQLDataType.NUMERIC(32, 17), this, "");

    /**
     * The column <code>public.metrics.iteration</code>.
     */
    public final TableField<MetricsRecord, Integer> ITERATION = createField(DSL.name("iteration"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.metrics.agent</code>.
     */
    public final TableField<MetricsRecord, Integer> AGENT = createField(DSL.name("agent"), SQLDataType.INTEGER.defaultValue(DSL.field("0", SQLDataType.INTEGER)), this, "");
    ...
    public Policy policy() {
        if (_policy == null)
            _policy = new Policy(this, Keys.METRICS__PM_FK_METRICS_POLICY);
