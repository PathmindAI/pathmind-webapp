...
public class SimulationParameterRecord extends TableRecordImpl<SimulationParameterRecord> implements Record6<Long, Long, Integer, String, String, ParamType> {
    ...
    @Override
    public Row6<Long, Long, Integer, String, String, ParamType> valuesRow() {
    ...
    @Override
    public SimulationParameterRecord value6(ParamType value) {
        setType(value);
        return this;
    }

    @Override
    public SimulationParameterRecord values(Long value1, Long value2, Integer value3, String value4, String value5, ParamType value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SimulationParameterRecord(Long modelId, Long experimentId, Integer index, String key, String value, ParamType type) {
        super(SimulationParameter.SIMULATION_PARAMETER);
