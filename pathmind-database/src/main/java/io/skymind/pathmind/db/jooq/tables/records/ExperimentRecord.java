...
public class ExperimentRecord extends UpdatableRecordImpl<ExperimentRecord> implements Record13<Long, Long, String, String, LocalDateTime, LocalDateTime, Boolean, String, Boolean, Boolean, Integer, Boolean, Boolean> {
     ...
     */
    public ExperimentRecord(Long id, Long modelId, String name, String rewardFunction, LocalDateTime dateCreated, LocalDateTime lastActivityDate, Boolean archived, String userNotes, Boolean isFavorite, Boolean hasGoals, Integer trainingStatus, Boolean sharedWithSupport, Boolean deployPolicyOnSuccess) {
        super(Experiment.EXPERIMENT);
