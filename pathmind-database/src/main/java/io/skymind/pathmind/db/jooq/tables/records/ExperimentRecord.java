...
public class ExperimentRecord extends UpdatableRecordImpl<ExperimentRecord> implements Record14<Long, Long, String, String, LocalDateTime, LocalDateTime, Boolean, String, Boolean, Boolean, Integer, Integer, Integer, Boolean> {

    private static final long serialVersionUID = 1964545319;
    ...
    @Override
    public Row14<Long, Long, String, String, LocalDateTime, LocalDateTime, Boolean, String, Boolean, Boolean, Integer, Integer, Integer, Boolean> valuesRow() {
    ...
    @Override
    public ExperimentRecord values(Long value1, Long value2, String value3, String value4, LocalDateTime value5, LocalDateTime value6, Boolean value7, String value8, Boolean value9, Boolean value10, Integer value11, Integer value12, Integer value13, Boolean value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ExperimentRecord(Long id, Long modelId, String name, String rewardFunction, LocalDateTime dateCreated, LocalDateTime lastActivityDate, Boolean archived, String userNotes, Boolean isFavorite, Boolean hasGoals, Integer trainingStatus, Integer goalsTotalNum, Integer goalsReachedNum, Boolean sharedWithSupport) {
        super(Experiment.EXPERIMENT);
