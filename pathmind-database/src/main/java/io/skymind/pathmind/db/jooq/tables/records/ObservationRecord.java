...
public class ObservationRecord extends UpdatableRecordImpl<ObservationRecord> implements Record11<Long, Long, Integer, String, String, String, String, Double, Double, Integer, Integer> {

    private static final long serialVersionUID = 2069130685;
    ...
    @Override
    public Row11<Long, Long, Integer, String, String, String, String, Double, Double, Integer, Integer> valuesRow() {
    ...
    @Override
    public ObservationRecord value10(Integer value) {
        setMinItems(value);
        return this;
    }

    @Override
    public ObservationRecord value11(Integer value) {
        setMaxItems(value);
        return this;
    }

    @Override
    public ObservationRecord values(Long value1, Long value2, Integer value3, String value4, String value5, String value6, String value7, Double value8, Double value9, Integer value10, Integer value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ObservationRecord(Long id, Long modelId, Integer arrayIndex, String variable, String dataType, String description, String example, Double min, Double max, Integer minItems, Integer maxItems) {
        super(Observation.OBSERVATION);
