...
public class ProjectRecord extends UpdatableRecordImpl<ProjectRecord> implements Record8<Long, Long, String, LocalDateTime, LocalDateTime, Boolean, String, ProjectType> {

    private static final long serialVersionUID = -1557661094;
    ...
    @Override
    public Row8<Long, Long, String, LocalDateTime, LocalDateTime, Boolean, String, ProjectType> valuesRow() {
    ...
    @Override
    public ProjectRecord values(Long value1, Long value2, String value3, LocalDateTime value4, LocalDateTime value5, Boolean value6, String value7, ProjectType value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ProjectRecord(Long id, Long pathmindUserId, String name, LocalDateTime dateCreated, LocalDateTime lastActivityDate, Boolean archived, String userNotes, ProjectType projectType) {
        super(Project.PROJECT);
