...
public class TrainingErrorRecord extends UpdatableRecordImpl<TrainingErrorRecord> implements Record5<Long, String, String, Boolean, String> {
    ...
    @Override
    public TrainingErrorRecord values(Long value1, String value2, String value3, Boolean value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TrainingErrorRecord(Long id, String keyword, String description, Boolean restartable, String supportArticle) {
        super(TrainingError.TRAINING_ERROR);
