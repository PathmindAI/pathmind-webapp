...
public class PolicyRecord extends UpdatableRecordImpl<PolicyRecord> implements Record9<Long, Long, String, String, LocalDateTime, LocalDateTime, LocalDateTime, Boolean, String> {
    ...
    @Override
    public Row9<Long, Long, String, String, LocalDateTime, LocalDateTime, LocalDateTime, Boolean, String> fieldsRow() {
        return (Row9) super.fieldsRow();
    }

    @Override
    public Row9<Long, Long, String, String, LocalDateTime, LocalDateTime, LocalDateTime, Boolean, String> valuesRow() {
    ...
    @Override
    public PolicyRecord values(Long value1, Long value2, String value3, String value4, LocalDateTime value5, LocalDateTime value6, LocalDateTime value7, Boolean value8, String value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PolicyRecord(Long id, Long runId, String externalId, String name, LocalDateTime startedAt, LocalDateTime stoppedAt, LocalDateTime exportedAt, Boolean hasFile, String checkPointFileKey) {
        super(Policy.POLICY);
