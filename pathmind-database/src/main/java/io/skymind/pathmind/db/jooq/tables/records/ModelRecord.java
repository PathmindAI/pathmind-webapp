...
public class ModelRecord extends UpdatableRecordImpl<ModelRecord> implements Record16<Long, Long, String, LocalDateTime, LocalDateTime, Integer, Boolean, String, Integer, Boolean, String, Integer, Integer, Boolean, Integer, Integer> {

    private static final long serialVersionUID = -1104678511;
    ...
    @Override
    public Row16<Long, Long, String, LocalDateTime, LocalDateTime, Integer, Boolean, String, Integer, Boolean, String, Integer, Integer, Boolean, Integer, Integer> valuesRow() {
    ...
    @Override
    public ModelRecord values(Long value1, Long value2, String value3, LocalDateTime value4, LocalDateTime value5, Integer value6, Boolean value7, String value8, Integer value9, Boolean value10, String value11, Integer value12, Integer value13, Boolean value14, Integer value15, Integer value16) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
