...
public class ModelRecord extends UpdatableRecordImpl<ModelRecord> implements Record14<Long, Long, String, LocalDateTime, LocalDateTime, Integer, Boolean, String, Integer, Boolean, String, Integer, Integer, Boolean> {

    private static final long serialVersionUID = -2055938090;
    ...
    @Override
    public Row14<Long, Long, String, LocalDateTime, LocalDateTime, Integer, Boolean, String, Integer, Boolean, String, Integer, Integer, Boolean> fieldsRow() {
        return (Row14) super.fieldsRow();
    }

    @Override
    public Row14<Long, Long, String, LocalDateTime, LocalDateTime, Integer, Boolean, String, Integer, Boolean, String, Integer, Integer, Boolean> valuesRow() {
    ...
    @Override
    public ModelRecord values(Long value1, Long value2, String value3, LocalDateTime value4, LocalDateTime value5, Integer value6, Boolean value7, String value8, Integer value9, Boolean value10, String value11, Integer value12, Integer value13, Boolean value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ModelRecord(Long id, Long projectId, String name, LocalDateTime dateCreated, LocalDateTime lastActivityDate, Integer numberOfObservations, Boolean archived, String userNotes, Integer rewardVariablesCount, Boolean draft, String packageName, Integer actionTupleSize, Integer invalidModel, Boolean hasGoals) {
        super(Model.MODEL);
