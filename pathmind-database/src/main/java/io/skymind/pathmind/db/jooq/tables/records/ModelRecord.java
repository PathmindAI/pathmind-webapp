...
public class ModelRecord extends UpdatableRecordImpl<ModelRecord> implements Record12<Long, Long, String, LocalDateTime, LocalDateTime, Integer, Integer, Boolean, String, Integer, Boolean, String> {

    private static final long serialVersionUID = -1667020321;
    ...
    @Override
    public Row12<Long, Long, String, LocalDateTime, LocalDateTime, Integer, Integer, Boolean, String, Integer, Boolean, String> valuesRow() {
    ...
    @Override
    public ModelRecord values(Long value1, Long value2, String value3, LocalDateTime value4, LocalDateTime value5, Integer value6, Integer value7, Boolean value8, String value9, Integer value10, Boolean value11, String value12) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ModelRecord(Long id, Long projectId, String name, LocalDateTime dateCreated, LocalDateTime lastActivityDate, Integer numberOfObservations, Integer numberOfPossibleActions, Boolean archived, String userNotes, Integer rewardVariablesCount, Boolean draft, String packageName) {
        super(Model.MODEL);
