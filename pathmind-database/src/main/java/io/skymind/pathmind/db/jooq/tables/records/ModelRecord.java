...
public class ModelRecord extends UpdatableRecordImpl<ModelRecord> implements Record11<Long, Long, String, LocalDateTime, LocalDateTime, Integer, Integer, Boolean, String, Boolean, Integer> {

    private static final long serialVersionUID = 746499312;
    ...
    @Override
    public Row11<Long, Long, String, LocalDateTime, LocalDateTime, Integer, Integer, Boolean, String, Boolean, Integer> valuesRow() {
    ...
    @Override
    public ModelRecord value11(Integer value) {
        setRewardVariablesCount(value);
        return this;
    }

    @Override
    public ModelRecord values(Long value1, Long value2, String value3, LocalDateTime value4, LocalDateTime value5, Integer value6, Integer value7, Boolean value8, String value9, Boolean value10, Integer value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ModelRecord(Long id, Long projectId, String name, LocalDateTime dateCreated, LocalDateTime lastActivityDate, Integer numberOfObservations, Integer numberOfPossibleActions, Boolean archived, String userNotes, Boolean draft, Integer rewardVariablesCount) {
        super(Model.MODEL);
