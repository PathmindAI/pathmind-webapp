...
public class RewardVariableRecord extends UpdatableRecordImpl<RewardVariableRecord> implements Record4<Long, Long, String, Integer> {

    private static final long serialVersionUID = 1489046590;
    ...
    @Override
    public RewardVariableRecord values(Long value1, Long value2, String value3, Integer value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public RewardVariableRecord(Long id, Long modelId, String name, Integer arrayIndex) {
        super(RewardVariable.REWARD_VARIABLE);
