...
public class Indexes {
    ...
    public static final Index GOALS_COUNT_MIGRATION_IDX = Internal.createIndex(DSL.name("goals_count_migration_idx"), Experiment.EXPERIMENT, new OrderField[] { Experiment.EXPERIMENT.HAS_GOALS, Experiment.EXPERIMENT.TRAINING_STATUS, Experiment.EXPERIMENT.GOALS_TOTAL_NUM, Experiment.EXPERIMENT.DATE_CREATED.desc() }, false);
