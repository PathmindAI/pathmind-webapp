...
public class RunRecord extends UpdatableRecordImpl<RunRecord> implements Record18<Long, Long, String, Integer, LocalDateTime, LocalDateTime, Integer, LocalDateTime, Long, String, String, LocalDateTime, String, String, Integer, DeploymentStatus, String, String> {
    ...
    /**
     * Setter for <code>public.run.policy_server_message</code>.
     */
    public void setPolicyServerMessage(String value) {
        set(16, value);
    }

    /**
     * Getter for <code>public.run.policy_server_message</code>.
     */
    public String getPolicyServerMessage() {
        return (String) get(16);
    }

    /**
     * Setter for <code>public.run.policy_server_url</code>.
     */
    public void setPolicyServerUrl(String value) {
        set(17, value);
    }

    /**
     * Getter for <code>public.run.policy_server_url</code>.
     */
    ...
    @Override
    public Row18<Long, Long, String, Integer, LocalDateTime, LocalDateTime, Integer, LocalDateTime, Long, String, String, LocalDateTime, String, String, Integer, DeploymentStatus, String, String> valuesRow() {
    ...
    public Field<String> field17() {
        return Run.RUN.POLICY_SERVER_MESSAGE;
    }

    @Override
    public Field<String> field18() {
        return Run.RUN.POLICY_SERVER_URL;
    }
    ...
    @Override
    public RunRecord value17(String value) {
        setPolicyServerMessage(value);
        return this;
    }

    @Override
    public RunRecord value18(String value) {
        setPolicyServerUrl(value);
        return this;
    }

    @Override
    public RunRecord values(Long value1, Long value2, String value3, Integer value4, LocalDateTime value5, LocalDateTime value6, Integer value7, LocalDateTime value8, Long value9, String value10, String value11, LocalDateTime value12, String value13, String value14, Integer value15, DeploymentStatus value16, String value17, String value18) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
    ...
    public RunRecord(Long id, Long experimentId, String name, Integer runType, LocalDateTime startedAt, LocalDateTime stoppedAt, Integer status, LocalDateTime notificationSentAt, Long trainingErrorId, String jobId, String rllibError, LocalDateTime ec2CreatedAt, String successMessage, String warningMessage, Integer completingUpdatesAttempts, DeploymentStatus policyServerStatus, String policyServerMessage, String policyServerUrl) {
        ...
        setStatus(status);
        setNotificationSentAt(notificationSentAt);
        setTrainingErrorId(trainingErrorId);
        setJobId(jobId);
        setRllibError(rllibError);
        setEc2CreatedAt(ec2CreatedAt);
        setSuccessMessage(successMessage);
        setWarningMessage(warningMessage);
        setCompletingUpdatesAttempts(completingUpdatesAttempts);
        setPolicyServerStatus(policyServerStatus);
        setPolicyServerMessage(policyServerMessage);
        setPolicyServerUrl(policyServerUrl);
    }
}
