...
public class MetricsRaw extends TableImpl<MetricsRawRecord> {
     ...
     */
    public final TableField<MetricsRawRecord, Long> POLICY_ID = createField(DSL.name("policy_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.metrics_raw.iteration</code>.
     */
    public final TableField<MetricsRawRecord, Integer> ITERATION = createField(DSL.name("iteration"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.metrics_raw.episode</code>.
     */
    public final TableField<MetricsRawRecord, Integer> EPISODE = createField(DSL.name("episode"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.metrics_raw.index</code>.
     */
    public final TableField<MetricsRawRecord, Integer> INDEX = createField(DSL.name("index"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
    ...
    public Policy policy() {
        return new Policy(this, Keys.METRICS_RAW__PM_FK_METRICS_RAW_POLICY);
    }
