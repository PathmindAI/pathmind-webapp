...
Feature: Demo projects
  ...
  Scenario Outline: Check demo projects create demo project
    ...
    Examples:
      ...
      | Interconnected Call Centers | DemoProjects/AutonomousMoonLanding.txt         | fuelRemaining,distanceToX,distanceToY,distanceToZ,landed,crashed,gotAway,throttlingUp,thottlingDown,movingDown,movingUp,movingLeft,movingRight,speedX,speedY,speedZ               | Select All,distanceXYZ,powerXYZ,moduleXYZ                                      | distanceXYZ,powerXYZ,moduleXYZ                                      |
