...
Feature: Demo projects
  ...
  Scenario Outline: Check demo projects create demo project
    ...
    Examples:
      ...
      | Automated Guided Vehicles   | DemoProjects/AutomatedGuidedVehiclesAGV.txt    | totalThroughput,fullConveyor,machineUtil,deliveryStage,trips,tripDuration,aveTripDuration,emptyOrigins,fullQueue,deliveryToFailedMachine,essentialDelivery,invalid,agvUtilization | Select All,AGVs_fleet,AGV_homeLocation,sourceLines,pl_inventory,pl_process,time | AGVs_fleet,AGV_homeLocation,sourceLines,pl_inventory,pl_process,time |
      ...
      | Interconnected Call Centers | DemoProjects/CallCenterRewardFunction.txt      | aMeanWaitTimes,aTotalBalked,ratio_balked                                                                                                                                          | Select All,currentCall,callCenters,links,hour,minute                            | currentCall,callCenters,links,hour,minute                            |
