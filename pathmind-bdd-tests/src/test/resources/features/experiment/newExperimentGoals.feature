...
Feature: New Experiment page goals
  ...
  Scenario: Create experiment with goals
    ...
    When Input reward variable 'balked_customers' goal '≥' value '3.456'
    When Input reward variable 'service_time' goal '≤' value '4.99'
    ...
    Then Check that new experiment reward variable 'balked_customers' goal is '≥' and value '3.456'
    Then Check that new experiment reward variable 'service_time' goal is '≤' and value '4.99'
  ...
  Scenario: Create experiment with partial goals
    ...
    When Click wizard reward variables next btn
    Then Check that new experiment AutotestProject page is opened
    Then Check that new experiment reward variable 'kitchen_cleanliness' goal is '≥' and value '0.0'
    Then Check that new experiment reward variable 'successful_customers' goal is '—' and value ''
    Then Check that new experiment reward variable 'balked_customers' goal is '≥' and value '1485.12'
    Then Check that new experiment reward variable 'service_time' goal is '≤' and value '158.0'
