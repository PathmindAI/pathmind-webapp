    ...
    public List<ExperimentManifest> getAll() {
        return List.of(
                ExperimentManifest.builder()
                        ...
                        .modelUrl(URI.create("https://s3.amazonaws.com/public-pathmind.com/tutorials/ProductDeliveryPathmindDemo.zip"))
                        .rewardFunction(
                                //@formatter:off
                ...
                ExperimentManifest.builder()
                        ...
                        .modelUrl(URI.create("https://s3.amazonaws.com/public-pathmind.com/tutorials/SupplyChainPathmindDemo.zip"))
                        .rewardFunction(
                                //@formatter:off
                ...
                ExperimentManifest.builder()
                        ...
                        .result("There is no comparison heuristic but AI learns to land safely on the moon without human intervention.")
                        .modelUrl(URI.create("https://s3.amazonaws.com/public-pathmind.com/tutorials/MoonLandingPathmindDemo.zip"))
                        .rewardFunction(
                                //@formatter:off
