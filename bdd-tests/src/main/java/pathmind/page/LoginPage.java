...
public class LoginPage extends PageObject {
    ...
    public void checkCreateNewUserPageElements() {
        WebElement signUpView = utils.expandRootElement(signUpShadow);
        assertThat(signUpView.findElement(By.cssSelector("vaadin-tab")).getText(), containsString("Get Started!"));
        assertThat(signUpView.findElement(By.cssSelector("vaadin-tab")).getAttribute("aria-selected"), containsString("true"));

        assertThat(signUpView.findElement(By.cssSelector("h3")).getText(), containsString("Sign up for 30 days Free Trial!"));
        assertThat(signUpView.findElement(By.cssSelector(".do-not-share-url")).getText(), containsString("Please do not share this URL"));
        assertThat(signUpView.findElement(By.cssSelector("#emailPart:nth-child(2)")).getText(), containsString("A credit card is not required and the email you provide will be used as the User Email during sign in."));
        ...
        WebElement cancelSignUpBtnShadow = signUpView.findElement(By.id("cancelSignUpBtn"));
        WebElement cancelSignUpBtn = utils.expandRootElement(cancelSignUpBtnShadow);
        assertThat(cancelSignUpBtnShadow.getText(), containsString("Cancel"));
        assertThat(cancelSignUpBtn.findElements(By.id("button")).size(), is(1));
    ...
    public void createNewUserCheckThatErrorMessageForEmailFieldShown(String errorMsg) {
        WebElement signUpView = utils.expandRootElement(signUpShadow);
        assertThat(signUpView.findElement(By.cssSelector(".error-message")).getText(), containsString(errorMsg));
    }
    ...
    public void checkPasswordRecoveryPageElements() {
        ...
        assertThat(resetPassView.findElement(By.cssSelector("vaadin-tab")).getText(), containsString("Reset Password"));
        assertThat(resetPassView.findElement(By.cssSelector(".section-title")).getText(), containsString("Please enter the user email and reset link will be sent"));
    ...
    public void checkLoginPageElements() {
        ...
        assertThat(getDriver().findElement(By.cssSelector(".title label")).isDisplayed(), is(true));
        assertThat(getDriver().findElement(By.cssSelector(".title label")).getText(), containsString("Sign in to your new account!"));
